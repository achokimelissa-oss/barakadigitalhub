      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "48px 24px" }}>
        ...
        <FadeIn>
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            ...
            <h1 className="font-display" style={{ fontSize: "2.8rem", fontWeight: 800, color: "#0f172a", letterSpacing: "-0.03em", marginBottom: 14 }}>Our AI Services in Detail</h1>
        ...
        <FadeIn delay={0.2}>
          <div style={{ marginTop: 48, background: "linear-gradient(135deg, #1d4ed8, #10b981)", borderRadius: 24, padding: "40px 36px", textAlign: "center" }}>
            <h3 className="font-display" style={{ fontSize: "1.8rem", fontWeight: 800, color: "white", marginBottom: 12 }}>Need a custom workflow?</h3>
...
const OperationsPage = ({ goBack, isMobile }) => {
  ...
  const pillars = [
    ...
    { n: "48 hours", label: "Turnaround Guarantee", color: "#0ea5e9", desc: "Most standard batches (up to 25K items) are delivered within 48 hours of task assignment. Rush timelines are supported with expanded shift coverage.", bullets: ["25K image batches in 48 hours", "Rush delivery with expanded coverage", "Proactive delay communication", "Daily progress updates to clients"] },
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f8fafc", paddingTop: 80 }}>
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "48px 24px" }}>
        ...
        <FadeIn>
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(16,185,129,0.07)", border: "1px solid rgba(16,185,129,0.12)", borderRadius: 100, padding: "6px 16px", marginBottom: 20 }}>
              <span style={{ fontSize: "0.72rem", fontWeight: 700, color: "#10b981", letterSpacing: "0.07em", textTransform: "uppercase" }}>Operational Infrastructure</span>
            </div>
            <h1 className="font-display" style={{ fontSize: "2.8rem", fontWeight: 800, color: "#0f172a", letterSpacing: "-0.03em", marginBottom: 14 }}>Built for Reliable Scale</h1>
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f8fafc", paddingTop: 80 }}>
      <div style={{ maxWidth: 980, margin: "0 auto", padding: "48px 24px" }}>
        ...
        <FadeIn>
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            <h1 className="font-display" style={{ fontSize: "2.8rem", fontWeight: 800, color: "#0f172a", letterSpacing: "-0.03em", marginBottom: 14 }}>How We Deliver</h1>
      ...
      <div style={{ maxWidth: 980, margin: "0 auto", padding: "48px 24px" }}>
        ...
        <FadeIn>
          <div style={{ marginBottom: 48 }}>
            ...
            <h1 className="font-display" style={{ fontSize: "2.8rem", fontWeight: 800, color: "#0f172a", letterSpacing: "-0.03em", marginBottom: 14 }}>About Us</h1>
        ...
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 20, marginBottom: 32 }}>
          {[
            ...
            <FadeIn key={i} delay={i * 0.07}>
              <div style={{ background: "white", borderRadius: 20, padding: "28px 24px", border: "1px solid #f1f5f9", boxShadow: "0 2px 12px rgba(0,0,0,0.04)" }}>
...
const CareersPage = ({ goBack, isMobile }) => {
  useEffect(() => { window.scrollTo(0, 0); }, []);
  const filters = ["All", "Remote", "Full-time", "Part-time", "Kenya", "AI / Data"];
  return (
    <div style={{ minHeight: "100vh", background: "#f8fafc", paddingTop: 80 }}>
      <div style={{ maxWidth: 980, margin: "0 auto", padding: "48px 24px" }}>
        <button onClick={goBack} style={{ display: "flex", alignItems: "center", gap: 8, background: "none", border: "none", cursor: "pointer", color: "#1d4ed8", fontWeight: 600, fontSize: "0.9rem", marginBottom: 32, fontFamily: "inherit" }}>
        ...
        <FadeIn>
          <div style={{ marginBottom: 32 }}>
            ...
            <h1 className="font-display" style={{ fontSize: "2.8rem", fontWeight: 800, color: "#0f172a", letterSpacing: "-0.03em", marginBottom: 14 }}>Join our growing team</h1>
        ...
        <FadeIn delay={0.05}>
          <div style={{ display: "flex", flexWrap: "wrap", gap: 10, marginBottom: 30 }}>
            {filters.map((f, i) => (
              <button key={i} style={{ padding: "10px 18px", borderRadius: 9999, border: "1px solid rgba(15,23,42,0.12)", background: "white", color: "#0f172a", fontWeight: 600, cursor: "pointer", fontSize: ".9rem" }}>
                {f}
              </button>
            ))}
          </div>
        ...
        <FadeIn delay={0.1}>
          <div style={{ background: "white", borderRadius: 24, padding: "40px 32px", border: "1px solid #e2e8f0", boxShadow: "0 18px 48px rgba(15,23,42,0.06)", textAlign: "center" }}>
            ...
            <a href="mailto:projects@barakadigitalhub.com" style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 8, padding: "14px 24px", borderRadius: 12, background: "#1d4ed8", color: "white", fontWeight: 700, textDecoration: "none" }}>
              Contact us about careers <ArrowRight size={16} />
            </a>
          </div>
        </FadeIn>
      </div>
    ...
    <div style={{ minHeight: "100vh", background: "#f8fafc", paddingTop: 80 }}>
      <div style={{ maxWidth: 980, margin: "0 auto", padding: "48px 24px" }}>
        ...
        <FadeIn>
          <div style={{ marginBottom: 32 }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(29,78,216,0.08)", border: "1px solid rgba(29,78,216,0.15)", borderRadius: 100, padding: "6px 16px", marginBottom: 20 }}>
              <span style={{ fontSize: "0.72rem", fontWeight: 700, color: "#1d4ed8", letterSpacing: "0.07em", textTransform: "uppercase" }}>Privacy Policy</span>
            </div>
            <h1 className="font-display" style={{ fontSize: "2.8rem", fontWeight: 800, color: "#0f172a", letterSpacing: "-0.03em", marginBottom: 14 }}>Privacy and data protection</h1>
            <p style={{ color: "#64748b", fontSize: "1.05rem", maxWidth: 720, lineHeight: 1.75, marginBottom: 24 }}>
              Baraka Digital Hub respects your privacy. We collect only the information we need to deliver services and keep your data secure with responsible controls.
            </p>
          </div>
        </FadeIn>
        ...
        <FadeIn delay={0.1}>
          <div style={{ display: "grid", gap: 20 }}>
            <div style={{ background: "white", borderRadius: 24, padding: "28px 30px", border: "1px solid #e2e8f0", boxShadow: "0 18px 48px rgba(15,23,42,0.06)" }}>
              <h2 className="section-h2" style={{ marginBottom: 14 }}>What we collect</h2>
              <p style={{ color: "#475569", lineHeight: 1.8 }}>We may collect your contact details, project requirements, and any information you choose to share so we can respond to inquiries and support our services.</p>
            </div>
            <div style={{ background: "white", borderRadius: 24, padding: "28px 30px", border: "1px solid #e2e8f0", boxShadow: "0 18px 48px rgba(15,23,42,0.06)" }}>
              <h2 className="section-h2" style={{ marginBottom: 14 }}>How we use it</h2>
              <p style={{ color: "#475569", lineHeight: 1.8 }}>Your data is used only to communicate with you, manage engagements, and improve our service delivery. We do not sell or share your personal information for marketing purposes.</p>
            </div>
            <div style={{ background: "white", borderRadius: 24, padding: "28px 30px", border: "1px solid #e2e8f0", boxShadow: "0 18px 48px rgba(15,23,42,0.06)" }}>
              <h2 className="section-h2" style={{ marginBottom: 14 }}>Your rights</h2>
              <p style={{ color: "#475569", lineHeight: 1.8 }}>You can request access to your data, ask for corrections, or contact us to remove information we hold about you.</p>
            </div>
          </div>
        </FadeIn>
      </div>
      ...
      <div style={{ maxWidth: 980, margin: "0 auto", padding: "48px 24px" }}>
        ...
        <FadeIn>
          <div style={{ marginBottom: 40, padding: "36px 28px", borderRadius: 24, background: "white", boxShadow: "0 24px 80px rgba(15,23,42,0.08)", border: "1px solid #e2e8f0" }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "8px 18px", borderRadius: 100, background: "rgba(29,78,216,0.08)", border: "1px solid rgba(29,78,216,0.16)", marginBottom: 20 }}>
              <span style={{ fontSize: "0.75rem", fontWeight: 700, color: "#1d4ed8", letterSpacing: "0.08em", textTransform: "uppercase" }}>Social Impact</span>
            </div>
            <h1 className="font-display" style={{ fontSize: "3rem", fontWeight: 900, color: "#0f172a", letterSpacing: "-0.03em", marginBottom: 18 }}>Baraka Digital Hub</h1>
        ...
        <FadeIn delay={0.05}>
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(auto-fit, minmax(220px, 1fr))", gap: 18, marginBottom: 40 }}>
            {[
              { label: "Youth unemployment in informal settlements", value: "67%" },
              { label: "Young people without formal employment", value: "1 in 3" },
              { label: "Children’s home youths in sustainable careers", value: "<5%" },
            ].map((item, index) => (
              <div key={index} style={{ background: "white", borderRadius: 20, padding: "26px 24px", border: "1px solid #e2e8f0", boxShadow: "0 12px 30px rgba(15,23,42,0.06)" }}>
                <div style={{ color: "#1d4ed8", fontSize: "2rem", fontWeight: 800, marginBottom: 10 }}>{item.value}</div>
        ...
        <FadeIn delay={0.3}>
          <div style={{ background: "#eef2ff", borderRadius: 24, padding: "32px", marginTop: 16, border: "1px solid #c7d2fe" }}>
            <h2 className="section-h2" style={{ marginBottom: 14 }}>Ready to turn your next brief into impact?</h2>
            <p style={{ color: "#475569", lineHeight: 1.8, marginBottom: 20 }}>
              Choose Baraka Digital Hub for reliable digital delivery, measurable social outcomes, and a partnership that grows opportunity for young people in Nairobi.
            </p>
            <a href="/contact" style={{ display: "inline-flex", alignItems: "center", gap: 10, padding: "14px 22px", borderRadius: 999, background: "#2563eb", color: "white", textDecoration: "none", fontWeight: 700 }}>
              Contact us to get started <ChevronRight size={16} />
            </a>
          </div>
        </FadeIn>
      ...
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "48px 24px" }}>
        ...
        <FadeIn>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            ...
            <h1 className="font-display" style={{ fontSize: "2.8rem", fontWeight: 800, color: "#0f172a", letterSpacing: "-0.03em", marginBottom: 14 }}>Start a Pilot Program</h1>
          ...
          <div style={{ background: "white", borderRadius: 24, padding: "36px 32px", border: "1px solid #f1f5f9", boxShadow: "0 8px 40px rgba(0,0,0,0.06)", marginBottom: 24 }}>
            ...
            {["Your dataset type (images, text, audio, video)", "Approximate volume and target timeline", "Annotation tool preference (or we can suggest one)", "Quality threshold and format requirements", "Whether you need a recurring or one-time engagement"].map((item, i) => (
              <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 12, marginBottom: i < 4 ? 14 : 0 }}>
                <div style={{ width: 22, height: 22, borderRadius: "50%", background: "linear-gradient(135deg, #1d4ed8, #10b981)", display: "flex", alignItems: "center", justifyContent: "center", color: "white", fontSize: 11, fontWeight: 800, flexShrink: 0, marginTop: 1 }}>{i + 1}</div>
        ...
        <FadeIn delay={0.16}>
          <div style={{ background: "linear-gradient(135deg, #1d4ed8, #10b981)", borderRadius: 20, padding: "36px 32px", textAlign: "center" }}>
    ...
    <div style={{ minHeight: "100vh", background: "white", fontFamily: "'DM Sans', sans-serif" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        .font-display { font-family: 'Inter', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif !important; }
        .page-container { width: min(100%, 1200px); margin: 0 auto; padding: 0 24px; }
        .hero-h1 { font-size: clamp(3rem, 5vw, 4.2rem) !important; }
        .section-h2 { font-size: clamp(2.1rem, 3vw, 3rem) !important; }
        .section-copy, .hero-copy, .body-copy { font-size: clamp(1rem, 1vw, 1.05rem); line-height: 1.75; max-width: 64rem; margin: 0 auto; }
      ...
      {page === "careers" && <CareersPage goBack={goBack} isMobile={isMobile} />}
              ...
              <div className="hero-grid" style={{ display:"grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap:56, alignItems:"center" }}>
                <div>
                  <div style={{ display:"inline-flex", alignItems:"center", gap:8, background:"rgba(29,78,216,.08)", border:"1px solid rgba(29,78,216,.15)", borderRadius:100, padding:"7px 16px", marginBottom:18 }}>
                    <span className="ani-pulse" style={{ width:7, height:7, borderRadius:"50%", background:"#10b981", display:"inline-block" }} />
                  ...
                  <h1 className="hero-h1 font-display" style={{ fontSize:"4.2rem", fontWeight:900, lineHeight:1.02, letterSpacing:"-.02em", color:"#0f172a", marginBottom:18 }}>
                    ...
                    <br />
                    <span style={{ background:"linear-gradient(90deg,#1d4ed8,#06b6d4,#10b981)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent", backgroundClip:"text", fontWeight:900 }}>Built for Scale</span>
                  </h1>
                      ...
                      {["Computer Vision Annotation","Natural Language Processing","Audio & Speech Processing","LLM Training & RLHF","Transcription & QA","Virtual Assistance & BPO"].map((item,i)=>(
                        <div key={i} style={{ display:"flex", alignItems:"center", justifyContent:"space-between", border:"1px solid #f1f5f9", borderRadius:10, padding:"10px 14px", background:"rgba(255,255,255,.7)", marginBottom: i<5?8:0 }}>
                          <div style={{ display:"flex", alignItems:"center", gap:9 }}>
                            <div style={{ width:7, height:7, borderRadius:"50%", background:"linear-gradient(135deg,#10b981,#06b6d4)", flexShrink:0 }} />
            ...
            <div style={{ maxWidth:1100, margin:"0 auto", position:"relative", zIndex:1 }}>
              ...
              <div style={{ display:"grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(3,1fr)", gap:14 }}>
                {[
                  ...
                  <FadeIn key={i} delay={i*.06}>
                    <div onClick={() => setPage("operations")} style={{ background:"rgba(255,255,255,.03)", border:"1px solid rgba(255,255,255,.07)", borderRadius:18, padding:"22px 20px", transition:"all .3s", cursor:"pointer" }}
                      onMouseEnter={e=>{e.currentTarget.style.borderColor="rgba(29,78,216,.4)";e.currentTarget.style.background="rgba(255,255,255,.06)";}}
                      ...
                      <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:14 }}>
                        <div style={{ width:36, height:36, borderRadius:10, background:"linear-gradient(135deg,#1d4ed8,#10b981)", display:"flex", alignItems:"center", justifyContent:"center", color:"white" }}>{o.icon}</div>
                    ...
                    <div style={{ background:"#020617", padding:"36px 32px" }}>
                      ...
                      {["Tasker onboarding & certification","Dataset segmentation & assignment","Annotation in client environment","100% QA review & validation","Error logging & recalibration","Final export, report & handoff"].map((step,i)=>(
                        <div key={i} style={{ display:"flex", gap:14, paddingBottom: i<5?22:0, position:"relative" }}>
                          ...
                          <div style={{ flexShrink:0, width:38, height:38, borderRadius:"50%", background:"linear-gradient(135deg,#1d4ed8,#10b981)", display:"flex", alignItems:"center", justifyContent:"center", fontFamily:"Syne,sans-serif", fontWeight:800, fontSize:13, color:"white", position:"relative", zIndex:1 }}>{i+1}</div>
              ...
              <FadeIn>
                <div style={{ display:"grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap:48, alignItems:"center" }}>
                  ...
                  <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
                    {[{n:"67%",l:"Youth unemployment in informal settlements",c:"#1d4ed8"},{n:"1 in 3",l:"Young people without formal employment",c:"#10b981"},{n:"<5%",l:"Children’s home youths in sustainable careers",c:"#d97706"}].map((s,i)=>(
                      <div key={i} style={{ background:"white", borderRadius:16, padding:"22px 24px", border:"1px solid #f1f5f9", boxShadow:"0 6px 24px rgba(15,23,42,0.04)", display:"flex", alignItems:"flex-start", gap:16 }}>
                        <div style={{ flexShrink:0, width:64, height:64, borderRadius:12, background:s.c, display:"flex", alignItems:"center", justifyContent:"center", color:"white", fontWeight:800, fontSize:"1.4rem" }}>{s.n}</div>
                        <div>
                          <p style={{ fontSize:"0.95rem", color:"#0f172a", fontWeight:700, marginBottom:6 }}>{s.l}</p>
                          <p style={{ fontSize:"0.87rem", color:"#64748b", lineHeight:1.6, margin:0 }}>We design programs and pathways that address these local challenges through jobs, training, and partnerships with employers.</p>
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            <div style={{ maxWidth:680, margin:"0 auto", textAlign:"center", position:"relative", zIndex:1 }}>
              <FadeIn>
                <div style={{ display:"inline-flex", alignItems:"center", gap:8, background:"rgba(29,78,216,.08)", border:"1px solid rgba(29,78,216,.15)", borderRadius:100, padding:"6px 16px", marginBottom:22 }}>
                  <span className="ani-pulse" style={{ width:6, height:6, borderRadius:"50%", background:"#10b981", display:"inline-block" }} />
            ...
            <div>
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:6 }}>
                ...
                <div style={{ display:"flex", flexWrap:"wrap", gap:12, marginTop:8 }}>
                  <a href="mailto:projects@barakadigitalhub.com" style={{ color:"rgba(255,255,255,0.95)", textDecoration:"none", fontWeight:700, minWidth:0, overflowWrap:"anywhere", wordBreak:"break-word" }}>projects@barakadigitalhub.com</a>
                  <span style={{ color:"rgba(255,255,255,.45)" }}>|</span>
                  <a href="tel:+25769258118" style={{ color:"rgba(255,255,255,0.95)", textDecoration:"none", fontWeight:700, minWidth:0, overflowWrap:"anywhere", wordBreak:"break-word" }}>+25769258118</a>
                </div>
              </div>
            </div>
...
ReactDOM.createRoot(document.getElementById('root')).render(<BarakaDigitalHub />);
