          ...
          <div style={{ display: "grid", gap: 24, marginBottom: 40 }}>
            <div style={{ background: "white", borderRadius: 24, padding: "32px", border: "1px solid #e2e8f0", boxShadow: "0 18px 48px rgba(15,23,42,0.06)" }}>
              ...
              <div style={{ color: "#475569", lineHeight: 1.9, marginBottom: 18 }}>
                ...
                <p>For many years, our focus at the Children’s Home was to provide safety, food, education, and love. But as our children grew, I could not ignore a deeper responsibility, preparing them for life beyond care.</p>
                ...
                <p>My heart remains with the community in Kayole and every child who passes through our doors. Care must evolve into empowerment, and charity must grow into dignity.</p>
              ...
              <div className="hero-grid" style={{ display:"grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap:56, alignItems:"center" }}>
                <div>
                  ...
                  <div style={{ display:"flex", gap:12, flexWrap:"wrap", marginBottom:36 }}>
                    ...
                    {[{v:"80+",l:"Taskers"},{v:"98%",l:"Avg Accuracy"},{v:"<4hr",l:"Response"},{v:"24hr",l:"Turnaround"}].map((s,i)=>(
